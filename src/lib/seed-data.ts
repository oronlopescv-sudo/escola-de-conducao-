// Conteúdo oficial de estudo: 23 módulos do Manual de Código de Estrada CV
// e banco de questões derivado do Decreto-Legislativo 4/2005.
// Usado pelo seed (prisma/seed.ts) e pelo auto-seed em produção (src/lib/bootstrap.ts).
...
export const QUESTOES_BASE: QuestaoBase[] = [
